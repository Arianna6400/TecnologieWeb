<nav class="navbar navbar-expand-lg navbar-light bg-light">
  <a class="navbar-brand" href="{{route('locatario')}}">HOME</a>
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    ...
    @csrf
      <input class="btn btn-outline-success mr-sm-2" type="submit" value ="Logout">
    </form>

    <a class="btn btn-outline-success mr-sm-2" type="submit" href="{{route('visualizzaprofilolocatario')}}">
